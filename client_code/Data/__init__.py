...
def get_tracking_table_background(year):
  return anvil.server.call('Calendar', 'get_tracking_table_background', brand=CURRENT_BRAND, agg_column='vendor_name', year=year, keep_columns=['vendor_name', 'vendor_id'])
